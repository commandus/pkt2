...
)
{
	...
	struct arg_str *a_allowed_messages = arg_strn("a", "allow", "<pkt.msg>", 0, 128, "Allowed message packet.name. Default any.");
	struct arg_int *a_allowed_packet_sizes = arg_intn("A", "allow-size", "<size>", 0, 128, "Allowed payload packet size. Default any.");
	...
	void* argtable[] = {
		a_proto_path, a_filename_input, a_input_hex,
		a_force_message, a_allowed_messages, a_allowed_packet_sizes,
